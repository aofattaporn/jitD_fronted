...
class _ProfilePageState extends State<ProfilePage> {
  ...
  final PostsBloc = BlocProvider<PostBloc>(create: (context) => PostBloc());
  final AuthenticationBloc _userBloc = AuthenticationBloc();
  final AuthenBloc = BlocProvider<AuthenticationBloc>(
      create: (context) => AuthenticationBloc());
  final PetBloc = BlocProvider<petBloc>(create: (context) => petBloc());
      ...
      body: SafeArea(
        child: RefreshIndicator(
          ...
          child: MultiBlocProvider(
            providers: [PostsBloc, AuthenBloc, PetBloc],
                                  ...
                                  BlocBuilder<petBloc, petState>(
                                    ...
                                    return BlocBuilder<AuthenticationBloc,
                                      ...
                                      builder: (context, state) {
                                        if (states is LoadingNamingPet) {
                                        ...
                                        } else if (states is LoadedNamingPet) {
                                          return IconButton(
                                            icon: Icon(
                                              Icons.create_rounded,
                                              color: Colors.black26,
                                          ...
                                          return Text(states.props.toString());
                                        }
                                      },
                                    );
                                  }),
