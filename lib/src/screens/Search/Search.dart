                        ...
                        Align(
                          ...
                          child: Container(
                              ...
                              child: GestureDetector(
                                onTap: () => Navigator.of(context).push(_createRoute(SearchQuery(searchHistory: searchHistory,))),
                                child: TextField(
                                  enabled: false,
                              ...
                              children: List.generate(searchHistory.length, (index) {
                                return Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(searchHistory[index], style: GoogleFonts.getFont("Bai Jamjuree", color: Colors.white, fontWeight: FontWeight.w500),),
                                  ),
                                );
                              }),
